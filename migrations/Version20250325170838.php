 ...
 */
final class Version20250325170838 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE business ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE business DROP created_at');
    }
}
